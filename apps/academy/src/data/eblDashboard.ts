...
export const eblCards: EblDashboardCard[] = [
  ...
  },
  {
    ...
    subtitle: 'Módulo Complementario · 3 Clases',
    description: 'Estrategias a medida para empleo remoto internacional, postulación sin experiencia previa y transición de carrera.',
    icon: 'Sparkles',
    colorScheme: {
      primary: '#7C3AED',
      bgGradient: 'linear-gradient(135deg, #FAF5FF 0%, #FFFFFF 100%)',
    ...
    badge: 'Optativo',
    features: [
      { iconName: 'Globe', label: 'Guía Remoto Internacional & Contractor' },
      { iconName: 'ArrowRightLeft', label: 'Proyectos sin Experiencia & Matriz de Transición' },
    ],
