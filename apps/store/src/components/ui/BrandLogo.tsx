...
interface BrandLogoProps {
  variant?: 'light' | 'dark' | 'arena' | 'orange';
        ...
        {showSubtitle && (
          <div className={styles.subtitleRow}>
            {branch ? (
              ...
              <span className={styles.genericSub}>PRENDAS & OBJETOS</span>
            )}
          </div>
        )}
      </div>
...
export function FMMonogram({
  ...
  size?: number;
  variant?: 'circle-navy' | 'circle-blue' | 'circle-orange' | 'circle-arena' | 'circle-marfil' | 'plain';
  className?: string;
}) {
  return (
    <div
